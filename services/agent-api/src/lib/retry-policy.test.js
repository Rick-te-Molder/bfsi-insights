...
async function loadModule() {
  return import('./retry-policy.js');
}

describe('lib/retry-policy', () => {
  beforeEach(() => {
    vi.clearAllMocks();
    vi.resetModules();
  });

  it('calculateDelay applies exponential backoff and caps at 5 minutes', () => {
    return loadModule().then(({ calculateDelay }) => {
