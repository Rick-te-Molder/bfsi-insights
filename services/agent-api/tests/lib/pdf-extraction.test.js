...
async function testPdfExtraction() {
  ...
  try {
    // Step 1: Test PDF detection and extraction
    ...
    // Step 2: Verify PDF is stored in Supabase Storage
    if (result.raw_ref) {
    ...
    // Step 3: Verify text content quality
    ...
    console.log(`   ${!hasGarbledText ? '✅' : '❌'} No garbled characters`);
