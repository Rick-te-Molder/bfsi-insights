-- ============================================================================
-- Migration: Add topic tagging to tagger v2.3
-- ============================================================================
-- Add topic tagging instructions to tagger prompt
-- Only use 5 valid topic codes from bfsi_topic table
-- ============================================================================
...
- **ecosystem**: Industry structure, market dynamics, partnerships, competition, M&A
- **methods-and-approaches**: Best practices, frameworks, methodologies, implementation approaches
- **regulatory-and-standards**: Compliance, regulations, regulatory guidance, standards, governance
- **strategy-and-management**: Business strategy, leadership, organizational change, transformation
- **technology-and-data**: Technology adoption, digital transformation, data analytics, AI/ML, cybersecurity
...
- Add to topic_codes array as simple strings (e.g., ["strategy-and-management", "technology-and-data"])

**Examples:**

Article: "How banks are using AI to transform customer service"
→ topic_codes: ["technology-and-data", "strategy-and-management"]

Article: "New Basel III capital requirements for European banks"
→ topic_codes: ["regulatory-and-standards"]

Article: "Mastercard acquires fintech startup to expand payment network"
→ topic_codes: ["ecosystem"]
...
- Empty arrays are acceptable when a category does not apply$PROMPT$,
  ...
  'DEV',
  true,
  'v2.3: Added topic tagging with 5 valid codes (ecosystem, methods-and-approaches, regulatory-and-standards, strategy-and-management, technology-and-data)'
);
