-- ============================================================================
-- Migration: Tagger v2.5 - Use placeholder-based prompt template
-- ============================================================================
-- Refactor tagger to use database prompt with placeholders for dynamic data
-- This allows prompt editing in the UI while keeping taxonomy data injection
-- ============================================================================
...
-- Insert new version with placeholder-based template
...
- Empty arrays are acceptable when a category does not apply$PROMPT$,
  ...
  'DEV',
  true,
  'v2.5: Refactored to use placeholder-based template for dynamic taxonomy injection. Clarified hierarchical tagging: tag ONLY most specific codes, parents added automatically.'
);
