...
> **Last updated:** 2026-01-28T16:13:06.295Z
...
| `kb_publication_audience`          | 152  | PK: publication_id |
...
| `pipeline_run`                     | 233  | PK: id             |
| `pipeline_run_costs`               | 118  |                    |
| `pipeline_step`                    | 8    | PK: id             |
| `pipeline_step_run`                | 422  | PK: id             |
